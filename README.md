...
- Model Evaluation: Marketers use a "Confusion Matrix" to see how many purchases were correctly predicted versus how many were missed. This is feedback loop will always allows data scientists to refine the ad campaign for better accuracy and higher return on investment.
