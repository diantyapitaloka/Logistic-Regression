...
- Model Evaluation: Marketers use a "Confusion Matrix" to see how many purchases were correctly predicted versus how many were missed. This feedback loop will allows data scientists to refine the ad campaign for better accuracy and higher return on investment.
